...
export const isValidIndianPhone = (phone: string): boolean => PATTERNS.INDIAN_PHONE.test(phone)
 ...
 */
export const validateStudentForm = (data: StudentFormPayload): string[] => {
  const errors: string[] = []
 ...
 * @returns Array of error messages (empty = valid).
 */
export const validateTeacherForm = (data: TeacherFormPayload): string[] => {
  const errors: string[] = []
 ...
 * @returns Array of error messages (empty = valid).
 */
export const validateSchoolForm = (data: SchoolFormPayload): string[] => {
  const errors: string[] = []
